...
namespace AlumnoEjemplos.Los_Borbotones
{
    public class CustomFpsCamera:TgcCamera
    {
        ...
        public const float DEFAULT_MOVEMENT_SPEED = 150f;
        ...
        public void updateCamera()
        {
            ...
            {
                GuiController.Instance.Logger.log(this.getPositionCode());
                return;
            }
